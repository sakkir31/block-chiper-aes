...
?>
  <head>
    <title>Halo, <?php echo $data['fullname']; ?> - Aplikasi Enkripsi dan Dekripsi AES 128 Bit</title>
    <meta charset="utf-8">
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="index.php" style="font-size:13pt">128 bit advanced encryption Standard (AES)</a>
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <legend>Enkripsi dan Dekripsi 128 bit advanced encryption Standard (AES)</legend>
