...
?>
  <head>
    <title>Halo, <?php echo $data['fullname']; ?> - Enkripsi dan Dekripsi -</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" href="../assets/css/main.css">
    
    <link rel="stylesheet" type="text/css" href="assets/css/atur.css">
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="index.php" style="font-size:13pt">AES 128 Bit</a>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-file"></i> Form Dekripsi Menggunakan Algoritma Advanced Encryption Standard (AES) 128 bit</h1>
          </div>
          <div>
            <ul class="breadcrumb">
