...
?>
  <head>
    <title>Halo, <?php echo $data['fullname']; ?> - Enkripsi dan Dekripsi AES 128 Bit</title>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-dashboard"></i>  Enkripsi dan Dekripsi Menggunakan Algortima AES 128 bit</h1>
          </div>
          <div>
            <ul class="breadcrumb">
